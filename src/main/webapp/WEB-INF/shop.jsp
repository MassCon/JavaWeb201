    ...
    <div class="col s12 m6">
        <div class="card blue">
            <div class="card-image">
                ...
                <a class="btn-floating halfway-fab waves-effect waves-light blue lighten-1 buy-character-btn" role="button" data-character-id="<%= character.getId() %>"
                   data-character-cost="<%= character.getCost() %>">
                    <i class="material-icons">add</i>
                </a>
            </div>
            <div class="card-content">
                <p>Cost: <b><%= character.getCost() %></b> $</p>
            </div>
        </div>
    </div>
    <% } %>
